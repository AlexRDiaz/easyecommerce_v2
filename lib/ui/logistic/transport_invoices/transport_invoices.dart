...
class TransportInvoices extends StatefulWidget {
  const TransportInvoices({super.key});

  @override
  State<TransportInvoices> createState() => _TransportInvoicesState();
}

class _TransportInvoicesState extends State<TransportInvoices> {
  List data = [];
    ...
    return ListTile(
      onTap: () {
        Navigators().pushNamed(
          context,
          '/layout/logistic/transport-invoices-by-date?id=$id',
        );
      },
      trailing: const Icon(
