...
class ProofPaymentsByTransport extends StatefulWidget {
  const ProofPaymentsByTransport({super.key});

  @override
  State<ProofPaymentsByTransport> createState() => _ProofPaymentsByTransportState();
}

class _ProofPaymentsByTransportState extends State<ProofPaymentsByTransport> {
  /// todo: formulario y detalle
  final ProofPaymentControllers _controllers =
  ProofPaymentControllers();
                    ...
                    return DataRow(
                      onSelectChanged: (bool? selected) {
                        Navigators().pushNamed(
                          context,
                          '/layout/logistic/proof-payments-by-transport/details?id=0',
                        );
                      },
                      cells: [
