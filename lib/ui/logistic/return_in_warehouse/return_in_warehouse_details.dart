...
class ReturnsInWarehouseDetails extends StatefulWidget {
  const ReturnsInWarehouseDetails({super.key});

  @override
  State<ReturnsInWarehouseDetails> createState() =>
      _ReturnsInWarehouseDetailsState();
}

class _ReturnsInWarehouseDetailsState extends State<ReturnsInWarehouseDetails> {
  String id = "";
