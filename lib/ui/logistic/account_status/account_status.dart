...
class _AccountStatusState extends State<AccountStatus> {
  ...
  loadData() async {
    ...
    //   valueWalletTemp.add((double.parse(responseWalletValue.toString() != "null"
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Lista Dinámica con Detalles'),
      ),
      body: Row(
        children: [
          Expanded(
              ...
              itemBuilder: (BuildContext context, int index) {
                return ListTile(
                  title:
                      Text(data[index]['attributes']['Nombre_Comercial'] ?? ""),
                  onTap: () {
                    getValue(data[index]['attributes']['Id_Master'] ?? "");
                    setState(() {
          ...
          Expanded(
            ...
            child: selectedItemIndex != -1
                ? Column(
                    ...
                    children: [
                      Text(
                        data[selectedItemIndex]['attributes']
                                ['Nombre_Comercial'] ??
                            "",
                        style: TextStyle(
