...
class DeliveryHistorial extends StatefulWidget {
  const DeliveryHistorial({super.key});

  @override
  State<DeliveryHistorial> createState() => _DeliveryHistorialState();
}

class _DeliveryHistorialState extends State<DeliveryHistorial> {
  List data = [];
  ...
  loadData() async {
    ...
    data = [
      {'date': '28/09/2023', 'id': 0,},
      {'date': '28/09/2023', 'id': 1,},
      {'date': '28/09/2023', 'id': 2,},
      {'date': '28/09/2023', 'id': 3,},
    ];
    ...
    return ListTile(
      onTap: () {
        Navigators().pushNamed(
          context,
          '/layout/logistic/delivery-history-by-date?id=$id',
        );
      },
      trailing: const Icon(
