...
class CCTransportInvoicesByDate extends StatefulWidget {
  const CCTransportInvoicesByDate({super.key});

  @override
  State<CCTransportInvoicesByDate> createState() => _TransportInvoicesByDateState();
}

class _TransportInvoicesByDateState extends State<CCTransportInvoicesByDate> {
  List data = [];
  String id="";
    ...
    return ListTile(
      onTap: () {
        Navigators().pushNamed(
          context,
          '/layout/logistic/cc-transport-invoices-by-date/by-transport?id=$id',
        );
      },
      trailing: const Icon(
