    ...
    try {
      ...
      for (int rowIndex = 0; rowIndex < orders.length; rowIndex++) {
        ...
        if (data["operadore"] != null &&
            data["operadore"]["up_users"] != null &&
            data["operadore"]["up_users"].isNotEmpty) {
          if (data["operadore"]["up_users"][0]["email"] != null &&
              data["operadore"]["up_users"][0]["email"].isNotEmpty) {
            sheet
                .cell(CellIndex.indexByColumnRow(
                    columnIndex: 6, rowIndex: rowIndex + 1))
                .value = data["operadore"]["up_users"][0]["email"];
          } else {
            sheet
                .cell(CellIndex.indexByColumnRow(
                    columnIndex: 6, rowIndex: rowIndex + 1))
      ...
      sheet
          .cell(CellIndex.indexByColumnRow(
              columnIndex: 8, rowIndex: (orders.length) + 1))
          .value = total;
