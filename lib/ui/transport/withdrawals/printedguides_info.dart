...
class PrintedGuideInfoTransport extends StatefulWidget {
  final String id;
  const PrintedGuideInfoTransport({super.key, required this.id});

  @override
  State<PrintedGuideInfoTransport> createState() => _PrintedGuideInfoTransportState();
}

class _PrintedGuideInfoTransportState extends State<PrintedGuideInfoTransport> {
  var data = {};
  bool loading = true;
