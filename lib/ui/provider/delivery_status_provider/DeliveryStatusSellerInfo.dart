...
class _DeliveryStatusSellerInfo2State extends State<DeliveryStatusSellerInfo2> {
  ...
  loadData() async {
    ...
    // print("novedades: ${data['novedades']}");
    if (data['novedades'].length >= 1) {
      List<dynamic> novedades = data['novedades'];

      if (novedades.isNotEmpty && widget.from == "logistic") {
                          ...
                          child: Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () async {
                                  _dateController.text = await OpenCalendar(
                      ...
                      ElevatedButton.icon(
                        onPressed: () async {
                          ...
                          if (solucionSelected == null) {
                            readyAdd = false;
                            showSuccessModal(context, "Seleccione una solucion",
                                Icons8.warning_1);
                          }
                          if (solucionSelected == "Volver a Ofrecer" &&
                              _dateController.text.isEmpty) {
                            readyAdd = false;
                            showSuccessModal(context, "Seleccione una fecha",
                                Icons8.warning_1);
                          ...
                          if (readyAdd) {
                            ...
                            if (resSolucionGTM != []) {
                              ...
                              if (statusError) {
                                ...
                                /*
                                "id_gestion" =>2,
"no_gestion" => 'texto',//apro
"nota"=>'texto'//no aplica solucion
                                 */
                                String mess = "";
                                if (resSolucionGTM['id_gestion'] == 2) {
                                  mess = resSolucionGTM['nota'];
                                  Navigator.pop(context);
  ...
  Future<String> OpenCalendar(String dateLastNov, String dateSent) async {
    String nuevaFecha = "";
                      ...
                      onPressed: () async {
                        if (data['operadore'] != null &&
                          ...
                          await updateGestionedNovelty(
                              context, data, _novObservacionController.text);
