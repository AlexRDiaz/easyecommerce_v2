...
import 'package:frontend/ui/provider/guidesgroup/printed_guides/controllers/controllers.dart';
...
class PrintedGuidesProvider extends StatefulWidget {
  ...
  @override
  State<PrintedGuidesProvider> createState() => _PrintedGuidesStateProvider();
}

class _PrintedGuidesStateProvider extends State<PrintedGuidesProvider> {
  PrintedGuidesControllersProvider _controllers =
      PrintedGuidesControllersProvider();
            ...
            content: Container(
              ...
              child: Column(
                children: [
                  ...
                  Expanded(
                      child: PrintedGuideInfoProvider(
