...
import 'package:frontend/ui/provider/guidesgroup/guides_sent/controllers/controllers.dart';
...
class TableOrdersGuidesSentProvider extends StatefulWidget {
  const TableOrdersGuidesSentProvider({super.key});

  @override
  State<TableOrdersGuidesSentProvider> createState() =>
      _TableOrdersGuidesSentStateProvider();
}

class _TableOrdersGuidesSentStateProvider
    extends State<TableOrdersGuidesSentProvider> {
  GuidesSentControllersProvider _controllers = GuidesSentControllersProvider();
  List data = [];
