            ...
            Expanded(
              child: DataTable2(
                ...
                columns: [
                  ...
                  DataColumn2(
                    label:
                        InputFilter('Código', codigoController, 'numero_orden'),
                  ...
                  DataColumn2(
                    label: InputFilter(
                        'Ciudad', ciudadShippingController, 'ciudad_shipping'),
                  ...
                  DataColumn2(
                    label: InputFilter('Dirección', direccionShippingController,
                        'direccion_shipping'),
                  ...
                  DataColumn2(
                    label: InputFilter(
                        'Cantidad', cantidadTotalController, 'cantidad_total'),
                    //label: Text('Cantidad'),
                    size: ColumnSize.S,
                    numeric: true,
                    onSort: (columnIndex, ascending) {
                  ...
                  DataColumn2(
                    label: InputFilter(
                        'Precio Total', precioTotalController, 'precio_total'),
                ...
                rows: List<DataRow>.generate(
                  ...
                  (index) => DataRow(
                    cells: [
                      ...
                      DataCell(getLengthArrayMap(data[index]['novedades']),
                          onTap: () {
                        openDialog(context, index);
                      }),
                      DataCell(
