...
class ChartDynamic extends StatefulWidget {
  final List<dynamic> sections;
  final double total;
  ChartDynamic({Key? key, required this.sections, required this.total})
      : super(key: key);

  @override
  State<ChartDynamic> createState() => _ChartDynamicState();
}

class _ChartDynamicState extends State<ChartDynamic> {
  int touchedIndex = -1;
