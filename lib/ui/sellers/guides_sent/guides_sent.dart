...
class GuidesSentSeller extends StatefulWidget {
  const GuidesSentSeller({super.key});

  @override
  State<GuidesSentSeller> createState() => _GuidesSentStateSeller();
}

class _GuidesSentStateSeller extends State<GuidesSentSeller> {
